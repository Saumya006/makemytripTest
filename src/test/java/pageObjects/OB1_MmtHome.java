...
public class OB1_MmtHome extends BasePage{
	...
	@FindBy(xpath="//div[@class='makeFlex']//ul//li//span") WebElement OutstationRadioBtn;
...
//	@FindBy(xpath="(//div[contains(text(),'23')])[2]") WebElement feb23;\
	...
	@FindBy(xpath="//iframe[@id='webklipper-publisher-widget-container-notification-frame']") WebElement adElement;
	@FindBy(xpath="//a[@id='webklipper-publisher-widget-container-notification-close-div']") WebElement closeBtn;
